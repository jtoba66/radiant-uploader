  ...
  return (
    <div className="App windows-font">
      {startup && <div className="startup-frame ">
		...
		<ul>
			<li>Using Radiant, your data embarks on a timeless journey, safeguarded for two centuries.</li>
			<li>Powered by the Jackal Protocol blockchain technology.</li>
			<li>Shareable links provide the path to access.</li>
			<li>The Jackal blockchain ensures triple-redundant data safety across the globe.</li>
